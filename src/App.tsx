  ...
  if (isLoading) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center relative overflow-hidden text-[#0a233c] select-none p-4">
        ...
        />
        {/* Soft authentic Aero sky tint overlay - clean without blur */}
        <div className="absolute inset-0 bg-sky-950/20" />

        {/* Pure Transparent Liquid Glass Loading Dialog Box */}
        <div className="w-full max-w-xs sm:max-w-sm rounded-[32px] p-6 sm:p-7 bg-gradient-to-b from-white/25 via-white/10 to-white/5 border border-white/60 shadow-[0_30px_70px_rgba(0,35,80,0.35),inset_0_2px_3px_rgba(255,255,255,0.85),inset_0_-1.5px_2px_rgba(255,255,255,0.2)] relative z-10 flex flex-col items-center gap-4 text-center overflow-hidden">
          ...
          <div>
            <h2 className="text-xl sm:text-2xl font-black text-white drop-shadow-[0_2px_4px_rgba(0,35,70,0.7)] tracking-tight">The Flannels pocket</h2>
            <p className="text-xs font-black text-sky-100 drop-shadow-[0_1px_3px_rgba(0,35,70,0.8)] mt-0.5 tracking-wide">This is the future we were promised</p>
          </div>

          {/* Authentic Vista Candy Progress Bar */}
          <div className="w-full space-y-1.5 pt-2">
            <div className="w-full h-4 bg-sky-950/30 rounded-full p-0.5 border border-white/80 shadow-inner overflow-hidden relative">
              <div
            ...
            <div className="flex items-center justify-between text-[11px] font-mono font-black text-white drop-shadow-[0_1px_2px_rgba(0,25,50,0.9)] px-0.5">
