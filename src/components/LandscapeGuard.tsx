...
export const LandscapeGuard: React.FC = () => {
  return (
    <div className="fixed inset-0 z-[99999] hidden portrait:flex flex-col items-center justify-center p-6 text-center select-none bg-gradient-to-b from-[#0b2b48]/95 via-[#07192b]/95 to-[#040e19]/95 backdrop-blur-xl text-white overflow-hidden">
      {/* Authentic Vista Aero glowing backdrop aura */}
      ...
      <div className="relative max-w-sm w-full rounded-3xl p-6 bg-white/10 backdrop-blur-2xl border border-white/30 shadow-[0_20px_50px_rgba(0,0,0,0.5)] flex flex-col items-center gap-4">
        ...
        <div className="space-y-1.5 z-10">
          ...
          <p className="text-xs text-sky-200/90 leading-relaxed font-medium">
            The Flannels Pocket dirancang untuk tampilan horizontal. Putar perangkat ke posisi landscape untuk melanjutkan.
          </p>
        </div>
