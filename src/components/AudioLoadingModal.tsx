...
export const AudioLoadingModal: React.FC<AudioLoadingModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-sky-950/25 animate-in fade-in duration-150 select-none">
      <div className="w-full max-w-sm sm:max-w-md rounded-[32px] bg-gradient-to-b from-white/25 via-white/10 to-white/5 border border-white/60 p-6 sm:p-7 shadow-[0_30px_70px_rgba(0,35,80,0.35),inset_0_2px_3px_rgba(255,255,255,0.85),inset_0_-1.5px_2px_rgba(255,255,255,0.2)] text-white relative overflow-hidden">
        {/* Top Dome Specular Glass Gloss */}
        <div className="absolute top-0 inset-x-0 h-1/2 bg-gradient-to-b from-white/40 via-white/10 to-transparent rounded-t-[32px] pointer-events-none" />
        ...
        <div className="relative z-10 flex flex-col items-center text-center space-y-4">
          ...
          <div className="space-y-1 max-w-full">
            <h3 className="text-base sm:text-lg font-black text-white drop-shadow-[0_2px_4px_rgba(0,35,70,0.7)] tracking-tight truncate px-2">
              {song.title}
            </h3>
            <p className="text-xs text-sky-100 drop-shadow-[0_1px_3px_rgba(0,35,70,0.8)] font-medium truncate px-2">
          ...
          <div className="flex items-baseline justify-center gap-1">
            <span className="text-4xl sm:text-5xl font-black font-mono tracking-tighter text-white drop-shadow-[0_2px_8px_rgba(0,35,70,0.8)]">
              {clampedPercent}
            </span>
            <span className="text-lg font-black font-mono text-cyan-200 drop-shadow-[0_1px_3px_rgba(0,35,70,0.8)]">%</span>
          </div>

          {/* Glossy Progress Bar Container */}
          <div className="w-full space-y-2">
            <div className="w-full h-4 bg-sky-950/30 rounded-full border border-white/80 p-0.5 relative overflow-hidden shadow-inner">
            ...
            <div className="flex items-center justify-between text-[11px] font-mono font-black text-white drop-shadow-[0_1px_2px_rgba(0,25,50,0.9)] px-1">
          ...
          {/* Reassurance Notice */}
          <div className="w-full p-2.5 rounded-2xl bg-sky-950/30 border border-white/30 flex items-start gap-2 text-[10px] text-sky-100 text-left font-medium">
